...
import correct from '../../assests/audio/correct.mp3'
import next from '../../assests/audio/next.mp3'
import missed from '../../assests/audio/missed.mp3'
...
export default class Play extends Component {
    ...
    handleNextButtonClick = () => {
        ...
        if (this.state.nextQuestion !== undefined) {
            this.setState(prevState => ({
                ...
                this.displayQuestions(this.state.nextQuestion, this.state.currentQuestion, this.state.nextQuestions, this.state.previousQuestion)
            })
        }
    }
    ...
    handleQuitButtonClick = () => {
        this.playButtonSound();
        if (window.confirm('are your sure you want to quit?')) {
    ...
    endGame = ()=>{
        ...
        const playerStats = {
            ...
            usedfiftyfifty: 2 - state.usedfiftyfifty,
    ...
    render() {
        const { currentQuestion, currentQuestionIndex, numberofQuestions, fiftyFifty, hints, time } = this.state;
        return (
            <Fragment>

                <Helmet><title>Play Quiz - Quiz App</title></Helmet>

                <Fragment>
                    <audio ref={this.correctSound} src={correct}></audio>
                    <audio ref={this.wrongSound} src={next}></audio>
                    <audio ref={this.buttonSound} src={missed}></audio>
                </Fragment>
